  ...
  return (
    ...
    >
      ...
      <p className="text-sm leading-relaxed text-ink-muted">
        ערכה רגשית־חברתית חווייתית ומקיפה לילדים בגילי 3–7, המעניקה לאנשי חינוך וטיפול דרך מובנית ויצירתית במטרה להפוך את הלמידה להרפתקה סוחפת שהילדים מחכים לה בכל פעם מחדש. דרך עולם קסום של סיפור, דמויות, משימות ואתגרים, הילדים מתחברים לחוזקות שלהם ורוכשים כלים משמעותיים לחיים.
      </p>
